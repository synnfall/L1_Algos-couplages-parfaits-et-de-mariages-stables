...
//                     complete = 0;
//                 }
//                 else if(get_max_tas_bin(current_elv->voeux[y]->places) > get_indice_pref_elvs(current_elv->voeux[y], current_elv))
//                 {
//                     complete = 0;
//                 }
//                 y++;
...
{
    while( !formations_complete(lst_formations,nb_forms))
    {
